...
import { TaskGroup, TimeCatMap, TimePeriod } from './Types';
	...
	return (
		<div>
			...
			{results.minutesData.alertSuspiciousDeadPeriod && (
				<strong>
					Please verify dead time periods as there is at least one suspiciously long dead
					period. Generally, this is a sign of bad data.
				</strong>
			)}
